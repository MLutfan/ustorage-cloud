...
<body class="h-screen w-full flex overflow-hidden">
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 bg-u-dark z-10">
        ...
        <div class="mb-8">
            <h2 class="text-3xl font-bold font-spartan text-u-text-light mb-2">Selamat Datang</h2>
            <p class="text-u-text-muted text-sm">Masuk ke akun Anda untuk mulai mengelola file.</p>
        </div>

        <form action="process/auth_process.php" method="POST" class="space-y-5">
            <div>
            ...
            <div>
                <label for="password" class="block text-sm text-u-text-muted mb-2">Kata Sandi</label>
                <div class="relative flex items-center">
                    ...
                    <button type="button" onclick="togglePassword('password', this)" class="absolute right-4 text-u-text-muted hover:text-u-neon focus:outline-none transition-colors duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 eye-closed">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 eye-open hidden">
            ...
            <button type="submit" name="login"
                class="w-full py-3.5 mt-4 rounded-xl bg-u-neon text-black font-semibold text-lg hover:bg-opacity-80 transition-all duration-300 shadow-[0_0_15px_rgba(163,230,53,0.3)] hover:shadow-[0_0_25px_rgba(163,230,53,0.5)]">
                Masuk
            </button>
        </form>

        <div class="mt-8 text-center md:text-left">
            <p class="text-u-text-muted text-sm">Belum punya akun? 
                <a href="register.php" class="text-u-text-light font-medium hover:text-u-neon transition-colors duration-300">Daftar di sini</a>
            </p>
        </div>
